...
Set<String> recordedFiles=new HashSet<String>();
...
public void read(String word) {
  ...
  println(" string received: "+word);  
  
  if (recordedFiles.add(word))
    textToSound(word);
...
void mousePressed() {
  ...
  OscMessage myMessage = new OscMessage("/TTS");
